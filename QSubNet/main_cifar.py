...
def main_worker(local_rank, args):
    ...
    if args.arch=='DARTS':
        if args.arch_cfg != None:
            ...
            model = quantdarts_cfg(args, local_rank, args.arch_cfg)  # load in best quantized weight configuration for training
...
def save_checkpoint(state, is_best, epoch, step_epoch, filename='checkpoint_subf_1.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_subf_1.pth.tar')
